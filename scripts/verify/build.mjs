...
for (const name of ['worldA', 'worldB', 'worldC', 'worldD', 'worldE', 'worldF', 'character-memory', 'worldG']) {
  await build({
    ...shared,
...
console.log('✅ 验收脚本已打包：phase1 / phase2a / phase2b0 / phase2b1 / phase2b2 / phase2b3 / phase2b4 / phase2b5 / phase2b6 / phase3 / phase3b / phase3c / worldA / worldB / worldC / worldD / worldE / worldF / character-memory / worldG');
