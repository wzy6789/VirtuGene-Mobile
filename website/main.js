...
(function () {
  ...
  /* ======================================================================
     ...
     ====================================================================== */
  var MAP_NODES = {
    core: { title: '世界', place: '正在持续', cast: '古月娜 · 艾莉 · 林霜', time: '此刻', beat: '你不在的时候，时间也会在这里留下痕迹。' },
    ...
    ice: { title: '冰原重逢', place: '极北冰原', cast: '古月娜', time: '清晨', beat: '她还没承认自己等了很久。（轨道暂停）' },
  };
